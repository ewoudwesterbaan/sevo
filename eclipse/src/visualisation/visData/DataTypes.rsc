...
// Voor TupComplexityRankCategory
import metrics::Rate;
...
// Een map met relatief aantal coderegels (in classes of in packages) per complexity rank (++, +, 0, -, --).
public alias ComplexityRankDistributionMap = map[TupComplexityRankCategory category, real lines];
